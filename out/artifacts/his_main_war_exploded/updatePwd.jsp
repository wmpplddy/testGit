        ...
        <div class="loginBox" style="background:#fff;opacity:0.9">
            ...
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-user" for="user-login-opassword"></label>
                    <input type="text" name="uname" value="${param.uname}" disabled id="user-login-opassword" lay-verify="required" placeholder="用户名" class="layui-input">
                </div>
...
<script>
    layui.use(function(){
        ...
        form.on('submit(user-login-submit)',function (data) {
            ...
            $.ajax({
                url:'<%=request.getContextPath()%>/updatePwdJSP',
                type:'post',
                data:field,
                dataType:'json',
