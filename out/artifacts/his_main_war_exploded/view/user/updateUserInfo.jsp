...
<div class="layui-row">
    <div class="layui-panel">
        <div class="layui-col-xs4" style="padding: 42px 12px 12px 32px;">
            <div class="layui-panel">
                ...
                <div class="layui-row" style="text-align: center;padding: 20px 0;">
                    <img class="layui-col-xs6 layui-col-md-offset3" id="ava"
                         style="border: 2px solid rgb(168, 225, 168);"
                         src="" alt="没有头像哦">
                </div>
        ...
        <div class="layui-col-xs8" style="padding: 42px 12px 12px 32px;">
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline layui-input-wrap">
                        <input type="text" name="truename" id="tname" autocomplete="off" value=""
                               class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline layui-input-wrap" style="width: 120px;">
                        <input type="text" name="age" id="age" lay-verify="required|number" autocomplete="off" value=""
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mail" id="mail" lay-verify="required|email" placeholder="有值时才校验" value=""
    ...
    function sub() {
        layui.use(function () {
            ...
            if(form.validate('#age')&&form.validate('#mail')&&form.validate('#phone')){
                ...
                $.ajax({
                    url:'<%=request.getContextPath()%>/updateU',
                    type:'POST',
                    data:user,
                    dataType:'json',
                    success:function(res){
                        if(res.code==200){
                            ...
                            //error.msg {phone mail}
                            var msg = res.msg;
                            layer.tips(msg=='phone'?'电话号码重复，请修改手机号':'邮箱已有绑定账号，请重新输入','#'+msg,{
